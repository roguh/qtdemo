...
def generate_qobject(object_name, props, more=None):
    """Returns strings containing C++ code that implements a QObject.
    Example
    generate_qobject("Object Name", [("propertyOne", "QString"), ("propertyTwo", "QObject")]
    """
    ...
    signals = "\n".join(         prop_template("    void ${name}Changed();"))
